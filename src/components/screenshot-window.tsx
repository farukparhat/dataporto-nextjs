...
export default function ScreenshotWindow({
  ...
  return (
    <div className={cn("bg-white rounded-xl md:rounded-2xl shadow-2xl border border-gray-200/50 overflow-hidden backdrop-blur-sm", className)}>
      ...
      <div className="hidden sm:block p-2 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
        <div className="flex items-center space-x-2">
          ...
          <div className="flex-1 bg-white rounded-md h-6 mx-4 flex items-center px-3">
            ...
            <div className="text-xs text-gray-500 font-mono hidden md:block">{url}</div>
            <div className="text-xs text-gray-500 font-mono md:hidden">{urlShort}</div>
          </div>
        </div>
      </div>
