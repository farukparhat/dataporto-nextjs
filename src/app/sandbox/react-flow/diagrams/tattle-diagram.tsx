...
// Custom component for the Tattle node
const TattleComponent = ({ className }: { className?: string }) => (
  <div className={`flex items-center space-x-2 justify-center ${className}`}>
    <Image
      src="/brands/tattle.png"
      alt="Tattle"
      width={0}
      height={0}
      sizes="100vw"
...
export default function TattleDataFlowDiagram() {
  const nodes: FlexibleDiagramNode[] = [
    // Tattle (Stage 0)
    {
      id: "tattle",
      label: "Tattle",
      customComponent: TattleComponent,
      description: "Tattle restaurant platform",
      variant: "default",
      stage: 0,
    },
  ...
  const connections: FlexibleDiagramConnection[] = [
    ...
    // Data delivery methods to clients with restaurant/food service data types
    {
      ...
      to: "mcdonalds",
      color: "#ef4444", // Red for McDonald's
      animated: true,
    ...
    <div className="p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">
          Tattle → Dataporto → Restaurant Partners Data Flow
        </h1>
        <FlexibleFlowDiagram
          nodes={nodes}
